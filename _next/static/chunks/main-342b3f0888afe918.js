(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
              ...
              n
                .replace(
                  n.pathname +
                    ...
                    String(
                      (0, E.assign)(
                        (0, E.urlQueryToSearchParams)(n.query),
      ...
      function $() {
        return ($ = g._(function* () {
          ...
          if (
            ...
            (a = (0, C.getURL)()),
            (0, B.hasBasePath)(a) && (a = (0, D.removeBasePath)(a)),
            o.scriptLoader)
          ) {
          ...
          return (
            ...
            ((u = (0, M.default)()).getIsSsr = () => n.isSsr),
            ...
            .then((r) => {
              ...
              return Promise.resolve(
                (null == (i = e.props) ? void 0 : i.err)
                  ? e.props
                  : (0, C.loadGetInitialProps)(t, f)
              ).then((t) =>
                el(
                  y._({}, e, { err: l, Component: u, styleSheets: c, props: t })
                )
              );
            })
        );
      ...
      class d {
        ...
        getDataHref(e) {
          let { asPath: t, href: r, locale: n } = e,
            { pathname: f, query: d, search: p } = (0, c.parseRelativeUrl)(r),
          ...
          return ((e) => {
            let t = (0, i.default)(
              (0, s.removeTrailingSlash)((0, l.addLocale)(e, n)),
              ".json"
            );
    ...
    6885: function (e, t, r) {
      ...
      Object.defineProperty(c, "events", { get: () => a.default.events }),
        s.forEach((e) => {
      ...
      function _(e) {
        ...
        if (
          ...
          ("beforeInteractive" === s || "worker" === s) &&
            (g
              ? ((y[s] = (y[s] || []).concat([
                  n._({ id: t, src: r, onLoad: o, onReady: a, onError: d }, h),
                ])),
                g(y))
              : _ && _()
              ? p.add(t || r)
      ...
      function u() {
        return (u = n._(function* (e) {
          let { Component: t, ctx: r } = e,
            n = yield (0, i.loadGetInitialProps)(t, r);
          return { pageProps: n };
        })).apply(this, arguments);
      }
    ...
    5932: function (e, t, r) {
      ...
      function H(e, t, r) {
        let [n, o] = (0, T.resolveHref)(e, t, !0),
          a = (0, h.getLocationOrigin)(),
          i = n.startsWith(a),
          l = o && o.startsWith(a);
        (n = U(n)), (o = o ? U(o) : o);
        let u = i ? n : (0, j.addBasePath)(n),
          c = r ? U((0, T.resolveHref)(e, r)) : o || n;
                  ...
                  if (i.startsWith("/")) {
                    ...
                    return Promise.all([
                      ...
                      let [i, { __rewrites: l }] = n,
                        u = (0, P.addLocale)(o.pathname, o.locale);
                      if (
                        (0, m.isDynamicRoute)(u) ||
                        (!a &&
                          i.includes(
                            (0, d.normalizeLocalePath)(
                              (0, S.removeBasePath)(u),
                              r.router.locales
                            ).pathname
                          ))
                      ) {
                      ...
                      if ((0, m.isDynamicRoute)(s)) {
                        let e = (0, y.getRouteMatcher)((0, _.getRouteRegex)(s))(
                          u
                        );
      ...
      function Y(e) {
        ...
        if (t === (0, j.addBasePath)((0, P.addLocale)(r.asPath, r.locale)))
          throw Error(
      ...
      class J {
        ...
        change(e, t, r, a, i) {
          ...
          return n._(function* () {
            ...
            f._inFlightRoute &&
              f.clc &&
              (X || J.events.emit("routeChangeError", k(), f._inFlightRoute, Z),
              f.clc(),
              (f.clc = null)),
              (r = (0, j.addBasePath)(
                (0, P.addLocale)(
                  (0, O.hasBasePath)(r) ? (0, S.removeBasePath)(r) : r,
                  a.locale,
                  f.defaultLocale
                )
              ));
            ...
            if (!q && f.onlyAHashChange(ee) && !et) {
              (G.asPath = ee),
                ...
                f.changeState(e, t, r, o._({}, a, { scroll: !1 })),
                Q && f.scrollToHash(ee);
              try {
                ...
                throw (
                  ((0, s.default)(e) &&
                    e.cancelled &&
                    J.events.emit("routeChangeError", e, ee, Z),
                  e)
                );
              }
            ...
            if (null == (n = f.components[en]) ? void 0 : n.__appRouter)
              return Y({ url: r, router: f }), new Promise(() => {});
            try {
              [B, { __rewrites: U }] = yield Promise.all([
            ...
            let ea = r;
            en = en
              ? (0, l.removeTrailingSlash)((0, S.removeBasePath)(en))
              : en;
            let ei = (0, l.removeTrailingSlash)(en),
              ...
              eu = !!(
                ...
                (!(0, m.isDynamicRoute)(ei) ||
                  !(0, y.getRouteMatcher)((0, _.getRouteRegex)(ei))(el))
              ),
              ec =
                !a.shallow &&
                (yield D({ asPath: r, locale: G.locale, router: f }));
            if (
              (q && ec && (W = !1),
              W &&
                "/_error" !== en &&
                ...
                er.pathname === en ||
                  ((en = er.pathname),
                  (er.pathname = (0, j.addBasePath)(en)),
                  ec || (t = (0, v.formatWithValidation)(er)))),
              !(0, M.isLocalURL)(r))
            )
              return Y({ url: r, router: f }), !1;
            (ea = (0, w.removeLocale)((0, S.removeBasePath)(ea), G.locale)),
              (ei = (0, l.removeTrailingSlash)(en));
            let es = !1;
            if ((0, m.isDynamicRoute)(ei)) {
              let e = (0, g.parseRelativeUrl)(ea),
                n = e.pathname,
                o = (0, _.getRouteRegex)(ei);
              es = (0, y.getRouteMatcher)(o)(n);
              let a = ei === n,
                i = a ? (0, I.interpolateAs)(ei, n, eo) : {};
              if (es && (!a || i.result))
                a
            ...
            try {
              ...
              if (
                ...
                let e = (0, O.hasBasePath)(er.pathname)
              ...
              if ("type" in n) {
                ...
                return (
                  Y({ url: n.destination, router: f }), new Promise(() => {})
                );
              }
              let l = n.Component;
              ...
              if ((n.__N_SSG || n.__N_SSP) && n.props) {
                ...
                if (
                  ((G.isPreview = !!n.props.__N_PREVIEW),
                  n.props.notFound === z)
                ) {
                  let e;
                  try {
              ...
              let w =
                q && !v && !V && !et && (0, R.compareRouterStates)(b, f.state);
              if (!w) {
                try {
                  yield f.set(b, n, v);
                } catch (e) {
                ...
                if (n.error)
                  throw (
                    (q || J.events.emit("routeChangeError", n.error, ee, Z),
                    n.error)
                  );
        ...
        handleRouteInfoError(e, t, r, o, a, i) {
          ...
          return n._(function* () {
            ...
            if ((0, u.isAssetError)(e) || i)
              throw (
                (J.events.emit("routeChangeError", e, o, a),
                Y({ url: o, router: l }),
                k())
              );
            try {
              let n;
              let { page: o, styleSheets: a } = yield l.fetchComponent(
                  "/_error"
                ),
                i = {
                  props: n,
            ...
            try {
              ...
              if (
                ...
                if (
                  ...
                  return o._({}, s, { route: e });
              }
              if ((0, E.isAPIRoute)(e))
                return Y({ url: i, router: b }), new Promise(() => {});
              let M =
                  x ||
                  (yield b.fetchComponent(e).then((e) => ({
                    Component: e.page,
              ...
              let { props: T, cacheKey: I } = yield b._getData(
                n._(function* () {
                  if (L) {
              ...
              return (
                M.__N_SSP && C.dataHref && I && delete b.sdc[I],
                b.isPreview ||
                  !M.__N_SSG ||
                  g ||
                  V(
          ...
          return n._(function* () {
            ...
            (n.pathname = F(n.pathname, f)),
              (0, m.isDynamicRoute)(n.pathname) &&
                ...
                Object.assign(
                  c,
                  (0, y.getRouteMatcher)((0, _.getRouteRegex)(n.pathname))(
                    (0, b.parsePath)(t).pathname
                  ) || {}
                ),
                h || (e = (0, v.formatWithValidation)(n)));
            let P = yield q({
              fetchData: () =>
                V({
            ...
            (yield a._bfl(t, d, r.locale, !0)) &&
              (a.components[i] = { __appRouter: !0 }),
              yield Promise.all([
                a.pageLoader._isSsg(w).then(
                  (t) =>
                    !!t &&
                    V({
                ...
                a.pageLoader[r.priority ? "loadPage" : "prefetch"](w),
              ]);
          })();
        }
        fetchComponent(e) {
          ...
          (this.sdc = {}),
            ...
            (this.onPopState = (e) => {
              ...
              (!this.isSsr ||
                ...
                u !== (0, j.addBasePath)(this.pathname)) &&
      ...
      function a(e, t, r, a) {
        ...
        return !a &&
          ((0, o.pathHasPrefix)(i, "/api") ||
            (0, o.pathHasPrefix)(i, "/".concat(t.toLowerCase())))
          ? e
    ...
    9473: function (e, t, r) {
      ...
      function l(e) {
        ...
        return (
          ...
          e.buildId &&
            (t = (0, a.addPathSuffix)(
              (0, o.addPathPrefix)(t, "/_next/data/".concat(e.buildId)),
    ...
    6373: function (e, t, r) {
      ...
      function i(e, t) {
        ...
        if (
          (u &&
            (0, a.pathHasPrefix)(f.pathname, u) &&
            ((f.pathname = (0, o.removePathPrefix)(f.pathname, u)),
            (f.basePath = u)),
          !0 === t.parseData &&
          ...
          parameterizedRoute: t
            .map((e) => {
              if (!(e.startsWith("[") && e.endsWith("]")))
                return "/".concat((0, o.escapeStringRegexp)(e));
              {
      ...
      ((t = {}).d = function (e, r) {
        ...
        (z = function (e, t) {
          ...
          if (l) {
            ...
            var u = function () {
              W[a.id] ||
                (i(l.takeRecords()), l.disconnect(), (W[a.id] = !0), r(!0));
            };
